...
(
	...
	'EMAIL' => '电子邮件地址',
	'PASSWORD' => '密码',
	'NO_IE_NOTICE' => '不支持IE系浏览器<br/><br/>请换用Chome、Firefox、UC、Opera、遨游或者Safari',
	'LOGIN_OK_NOTICE' => '成功登录，正在跳转中',
	'API_CONNECT_ERROR_NOTICE' => '尝试连接服务器失败，请稍后再试',
	'LOGIN_BAD_ARGS_NOTICE' => '错误的Email地址或者密码，请重试',
	'ADMIN_ONLY_LOGIN' => '只有管理员才能进入此页面，<a href="?c=guest&a=logout">请先使用管理员账户登入</a>',
	'INDEX_PAGE' => '首页',
	'TEAM_FEED' => '团队动态',
	'TEAM_MEMBER' => '成员管理',
	'INBOX' => '收件箱',
	...
	'DB_UPGRADE_SUCCESS'=>'更新完成，请<a href="?c=dashboard">刷新页面以保证新代码正常工作</a>',
	...
	'CODE_UPGRADE_SUCCESS'=>'成功更新，请<a href="?c=inbox">刷新页面以保证新代码正常工作</a>',
	...
	'API_TEXT_JOINT_TODO' => '%s加入了ZhengruiTeamTODO',
	'API_TEXT_NEW_VERSION' => 'ZhengruiTeamTODO%s版已经发布',
	...
	'API_TEXT_ALREADY_UPGARDE_TO' => '您的ZhengruiTeamTODO已经升级至%s版本，<a href="%s">请立即点击这里升级数据表</a>',
	...
	'NEED_LOGIN' => '您访问的页面需要先<a href="?c=guest">登录</a>',
	'MEMBER_PAGE_TITLE' => '团队成员',
	'FEED_PAGE_TITLE' => '团队动态',
	'INBOX_PAGE_TITLE' => '收件箱',
	'INSTALL_PAGE_TITLE' => 'ZhengruiTeamTODO安装页面',
	...
	'DATABASE_INIT_FINISHED' =>  '数据库初始化成功，请使用【admin@outlook.com】和【%s】<a href="/" target="new">登入并添加用户</a>' ,
	'FEED_LOAD_ERROR_RETRY' => '加载动态失败，请重试',
	'INSTALL_FINISHED' => 'API Server 已初始化完成，<a href="?c=guest">请使用Admin账号登入</a>',
	'BAD_ARGS' => '错误的参数',
	...
	'FROM_MOBILE_DEVICE' => '来自移动版',
	'FROM_WEB_DEVICE' => '来自网页版',
	'TODO_INTRO_TEXT' => 'ZhengruiTeamTODO是为创新团队设计的效率工具".',
	'ABOUT_VERSION_TEXT' => '版本 - %s',
	'ABOUT_SITE_TEXT' => '官方网站 - 暂无',
	'ABOUT_SUPPORT_TEXT' => '客户支持QQ群 - 暂无',
	'TEAMTOY_STAFF' => '开发团队',
	'ABOUT_STAFF_BLOCK' => '开发者: 孔祥瑞',
	'LIST_LOAD_MORE' => '载入更多',
	...
	'SCAN_QRCODE_VIA_MOBILE_CLIENT' => '请使用客户端扫描',
	'UPLOAD' => '上传',
	...
	'FOOTER_INFO' => 'ZhengruiCloud &copy 正瑞云 孔祥瑞荣誉出品 2018~%s.',
	...
	'JS_NOTICE_PREFIX' => 'ZhengruiTeamTODO有',
	...
	'JS_SENDKEY_NULL' => 'SENDKEY不可以为空',
	'JS_SENDKEY_SAVED' => '成功的设置了您的SENDKEY',
	'WEIBO_LINK' => 'http://s.weibo.com/user/%s',
	'BUG_REPORT' => '反馈BUG',
	'SET_SENDKEY_INPUT' => '请输入您的SENDKEY',
	'SET_SENDKEY' => '设置SENDKEY',
	'SET_SK' => '设置微信提醒',
	'TTEST' => ''
);