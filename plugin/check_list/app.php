...
(
	...
	'JS_PL_CHECK_LIST_MARK_TODO_READ_CONFIRM' => '你已经完成了TODO的全部检查项，要将TODO标记为完成么？',
	'JS_PL_CHECK_LIST_TEMPLATE_REMOVE_CONFIRM' => '确定要删除检查项模板【%s(%s)】吗？',
	'JS_PL_CHECK_LIST_TEMPLATE' => '编辑检查项模板',
	'JS_PL_CHECK_LIST_TEMPLATE_UPDATED' => '模板内容已保存',
	'JS_PL_CHECK_LIST_TEMPLATE_NAME' => '请输入模板名称',
	'JS_PL_CHECK_LIST_TEMPLATE_INTRO' => '填写检查项检查项，每行一条',
